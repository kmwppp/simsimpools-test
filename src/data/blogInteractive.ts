...
export const blogInteractiveById: Record<string, BlogInteractive> = {
  ...
  'stress-types': {
    title: '스트레스 직후 첫 반응 기록하기',
    description: '처음 한 행동의 짧은 이득과 뒤에 남은 비용을 나눠봅니다.',
    blocks: [
      {
        type: 'choice',
        id: 'stress_release',
        label: '스트레스 직후 가장 먼저 한 행동',
        options: ['관련 일을 한꺼번에 더 벌였다', '화면이나 자리를 피했다', '같은 내용을 반복해서 확인했다', '괜찮은 척하며 그대로 이어갔다'],
      },
      {
        type: 'checklist',
        id: 'stress_signs',
        label: '해결 행동인지 구별할 기준',
        items: [
          '끝나면 확인되는 사실이나 결과가 있다',
          '몇 분 또는 몇 번 뒤에 멈출지 정할 수 있다',
          '한 시간 뒤 해야 할 일이나 관계 비용이 더 늘지 않는다',
        ],
      },
      {
        type: 'memo',
        id: 'stress_exit',
        label: '상황·첫 행동·잠깐의 이득·남은 비용',
        placeholder: '예: 숫자 오류 지적 / 메일 반복 확인 / 잠깐 안심 / 수정이 늦어짐',
      },
    ],
  },
  perfectionism: {
