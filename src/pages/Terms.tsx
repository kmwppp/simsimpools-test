    ...
    <>
      ...
      >
        ...
        <div className="info-box mb-8">
          <strong>핵심 요약:</strong> 심심풀이의 문답과 에세이는 개인적인 관찰을 돕기 위한
          콘텐츠로, 전문적인 심리 진단이나 의료 행위를 대체하지 않습니다. 사이트는
          광고를 통해 운영될 수 있습니다.
        </div>

        <h2 id="sec1">제1조 (목적)</h2>
        <p>
          이 약관은 {SITE_NAME}(이하 "서비스" 또는 "회사")가 운영하는 콘텐츠 사이트
          ({BASE_URL})의 이용에 관한 조건, 절차, 권리와 의무, 기타 필요한 사항을 규정함을
          목적으로 합니다.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>"콘텐츠"</strong>란 서비스가 제공하는 짧은 문답, 결과, 에세이 글,
        ...
        <ul>
          <li>일상의 반응을 돌아보는 짧은 문답과 결과 콘텐츠</li>
          <li>감정·관계·회복을 다루는 관찰 에세이 및 읽을거리</li>
          <li>개인적인 관찰을 돕는 정보 콘텐츠</li>
        </ul>
        <p>
        ...
        <div className="highlight-box">
          ⚠️ {SITE_NAME}의 문답과 결과는 개인적인 관찰을 돕기 위해 제작된 콘텐츠입니다.
          전문적인 심리 진단·정신건강 평가·의료 행위를 대체하지 않습니다.
        </div>
        <p>
          문답 결과는 참고 자료로만 활용하시기 바랍니다. 심각한 심리적·정서적 어려움을 겪고
          계신다면 반드시 자격을 갖춘 심리상담사 또는 정신건강의학과 전문의의 도움을 받으시기
          바랍니다.
        </p>
        <p>
          {SITE_NAME}는 문답 결과의 정확성이나 완전성을 보장하지 않으며,
