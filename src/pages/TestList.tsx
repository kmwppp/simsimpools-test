...
export function TestList() {
  return (
    <>
      <SEOMeta
        title="심리 테스트 — 성격·연애·스트레스 반응 무료 테스트"
        description="왜 이렇게 되는 건지 설명하기 어려운 날들을 위한 테스트. 성격 유형, 연애 성향, 스트레스 반응, 감정 회복 방식을 관찰하는 무료 심리 테스트 5가지."
        canonical="/tests"
        keywords={['심리테스트', '성격테스트', '연애성향테스트', 'MBTI', '무료심리테스트', '스트레스테스트']}
      />
      ...
      <div className="bg-white border-b border-slate-100">
        <div className="section-container py-10">
          ...
          <p className="text-slate-500">설명하기 어려운 내 반응들을 조금 더 선명하게. 모두 무료입니다.</p>
        </div>
      </div>
      ...
      <div className="section-container py-12">
        ...
        <div className="mb-14 max-w-2xl">
          ...
          <p className="text-slate-700 leading-[1.92] mb-8 text-[0.975rem]">
            여기에 있는 테스트들은 그런 장면들과 연결되어 있습니다.
            성격 유형, 스트레스 반응, 연애 성향, 감정 회복 방식, 인간관계에서의 거리감까지 —
            심리학 이론을 배우기 위한 게 아니라,
          ...
          <p className="text-slate-600 leading-[1.92] mb-4 text-[0.975rem]">
            테스트 결과는 정답이 아닙니다. 내가 어떤 유형인지를 증명하는 자료라기보다,
            지금의 나를 관찰하는 출발점에 가깝습니다.
            같은 테스트를 1년 뒤에 다시 하면 결과가 달라지는 경우도 있고,
          ...
          <p className="text-slate-600 leading-[1.92] text-[0.975rem]">
            ...
            테스트는 나를 분류하기 위한 도구가 아니라, 나를 관찰하는 작은 계기에 가깝습니다.
          </p>
        </div>
