...
export function Disclaimer() {
  return (
    <>
      <SEOMeta
        title="면책고지"
        description={`${SITE_NAME}의 면책고지입니다. 문답 결과의 성격, 콘텐츠 한계, 광고 및 외부 링크 면책 등을 확인하세요.`}
      ...
      >
        ...
        <div className="highlight-box mb-8">
          ⚠️ <strong>중요 안내:</strong> 심심풀이의 모든 콘텐츠는 개인적인 관찰과 읽을거리를 위해
        ...
        <p>
          심심풀이({BASE_URL})에서 제공하는 모든 콘텐츠—짧은 문답, 결과, 에세이,
          안내 글 등—는 일상의 감정과 관계를 돌아보기 위해 제작된 일반 정보 콘텐츠입니다.
        </p>
        <p>
        ...
        {/* 2. 문답 결과 면책 */}
        <h2 id="sec2">2. 문답 결과 면책고지</h2>
        <p>
          심심풀이의 문답 결과는 다음과 같은 한계를 가집니다.
        </p>
        <ul>
          <li>
            본 문답은 표준화된 임상 심리 검사(예: MMPI, 로르샤흐 검사, K-WISC 등)가
            아닙니다.
          </li>
          <li>
            문답 결과는 응답 시점의 심리 상태, 기분, 최근 경험 등에 따라 달라질 수 있으며,
            고정된 성격이나 심리 상태를 나타내지 않습니다.
          </li>
          <li>
            동일 개인도 다른 시점에 문답을 진행하면 다른 결과가 나올 수 있습니다.
          </li>
          <li>
            문답 결과는 개인적인 관찰의 출발점으로만 활용하시고, 중요한 결정의 근거로 삼지
            마시기 바랍니다.
          </li>
        </ul>
