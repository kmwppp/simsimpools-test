          ...
          <article className="space-y-12">
            ...
            <section>
              ...
              <div className="rounded-2xl bg-slate-50 border border-slate-200 p-6 text-slate-600 leading-relaxed space-y-3">
                <p>
                  이 사이트는 심심풀이 운영자 1인이 운영합니다. 운영자는 전문 상담가, 임상심리사 또는
                  의료인이 아닙니다. 문답은 전문 상담, 표준화 검사, 의료적 판단 또는 진단을 대신하지 않습니다.
                </p>
                <p>
                  심각하거나 지속되는 증상을 문답 결과만으로 판단하거나 그 결과에만 기대어 대응하지 마세요.
                  필요한 경우 상황에 맞는 전문가나 기관의 도움을 이용해야 합니다. 중요한 건강·관계·진로
